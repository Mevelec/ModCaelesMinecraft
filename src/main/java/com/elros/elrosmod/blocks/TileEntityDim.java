		...
		if ((player.getRidingEntity() == null) && ((player instanceof EntityPlayerMP)))
		{
			...
			if(player1.timeUntilPortal > 0)
			{
				...
				if(prevX2 == 0.0 && prevY2 == 0.0 && prevZ2 == 0.0)
				{
					...
					mcServer.getPlayerList().transferPlayerToDimension(player1, 3, new CaelesTeleporter(mcServer.getWorld(3), dme2, 0, 0 ,0));
					...
					setDme22();
					setOverworldXYZ(player1.posX, player1.posY, player1.posZ);
					mcServer.getPlayerList().transferPlayerToDimension(player1, 3, new CaelesTeleporter(mcServer.getWorld(3), dme2, prevX2, prevY2, prevZ2));
				...
				setDme22();
				setTestXYZ(player1.posX, player1.posY, player1.posZ);
				mcServer.getPlayerList().transferPlayerToDimension(player1, 0, new CaelesTeleporter(mcServer.getWorld(0), dme2, prevX, prevY, prevZ));
