...
public class CaelesTeleporter extends Teleporter
{
	...
	private final Long2ObjectMap<CaelesTeleporter.PortalPosition> destinationCoordinateCache = new Long2ObjectOpenHashMap(4096);

	public CaelesTeleporter(WorldServer worldIn, int dme2, double x, double y, double z)
	{
	...
	public boolean makePortal(Entity entityIn)
	{
		...
		IBlockState iblockstate = ModBlocks.CAELES_PORTAL_BLOCK.getDefaultState().withProperty(BlockPortal.AXIS, l6 == 0 ? EnumFacing.Axis.Z : EnumFacing.Axis.X);
